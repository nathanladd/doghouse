// Electrical Diagnostics Training - Main JavaScript
...
function buildHeader() {
  ...
  const acIdx = parts.lastIndexOf('electrical-diagnostics');
  ...
  header.innerHTML = `
    <div class="logo"><a href="${courseHref}" style="text-decoration: none; color: inherit;">Electrical <span>Diagnostics</span></a></div>
    <div class="breadcrumb">${breadcrumbHtml}</div>
    <div class="header-search" role="search">
      <input type="search" class="header-search-input" placeholder="Search this course&hellip;" aria-label="Search the Electrical Diagnostics course" autocomplete="off" spellcheck="false">
  ...
  // "depth - 1" is the number of "../" hops from this page up to electrical-diagnostics/.
  initSearch('../'.repeat(Math.max(depth - 1, 0)));
}

// ---------------------------------------------------------------------------
// Site search (electrical-diagnostics subsite only)
//
...
var searchBase = '';             // "../" hops from the current page to electrical-diagnostics/
